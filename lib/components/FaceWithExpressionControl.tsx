...
import type { FaceProfile, FacialExpression } from '../types';
...
> {
  ...
  changeExpression() {
    const list = Object.entries(expressions).filter(
      (keyAndExpression) => keyAndExpression[1] !== this.state.expresion
    );
